...
export class CreateExtensionStatusEntity1708449230731 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "extension_status" ("id" SERIAL NOT NULL, "status" "public"."extension_status_status_enum" NOT NULL DEFAULT 'available', CONSTRAINT "PK_53112d6352d32408a7deafde572" PRIMARY KEY ("id"))`
    );
  }
